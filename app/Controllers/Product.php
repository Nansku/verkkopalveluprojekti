...
class Product extends BaseController
{
  ...
  public function changeCategory() {
    $categorynum = $this->request->getPost('categorynum');
    $this->index($categorynum);
  }
   ...
   */
  public function save($categorynum,$productID = null) {
    // Asetetaan otsikko sen mukaan, ollaanko lisäämässä vai muokkaamassa tuotteen tietoja.
    if ($productID != null || $this->request->getPost('productID')!=null) {
    ...
    if ($this->request->getMethod() === 'post') {
      if (!$this->validate([
        ...
        $save['categorynum'] = $categorynum;
        $save['productID'] = $this->request->getPost('productID');
        ...
        return redirect()->to(site_url('/product/index/' . $categorynum));
      }      
    }
