...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light pr-5 pl-5">
        <!-- Logo -->
        <a class="navbar-brand active" href="<?= site_url('Admin/index')?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item ml-5 mt-2 nav-og">
                    <a class="nav-link active nav-txt"  href="<?= site_url('Admin/index')?>">
                ...
                <li class="nav-item nav-og dropdown ml-5">
                    ...
                    <div class="dropdown-divider"></div>
                        ...
                        <a class="dropdown-item nav-txt-dropdown" href="<?= site_url('/coffee/products/' . $category['category_id'])?>"><?=$category['categoryname']?></a>
                        <?php endforeach; ?>
                    </div>
                </li>
            ...
            <ul class="navbar-nav mr-5">
                ...
                <li class="nav-item ml-5 mt-2 nav-gr">
                    <a class="nav-link active nav-txt"  href="<?= site_url('Coffee/admin_my_page')?>">
                    <i class="fas fa-user mr-2"></i>Admin Page</a>
                </li>
